...
# from lib.models.sttrack.sttrack import build_starks
...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='stark_st2', choices=['sttrack', 'stark_st2'],
...
if __name__ == "__main__":
    ...
    '''import sttrack network module'''
    model_module = importlib.import_module('lib.models.sttrack')
    if args.script == "sttrack":
