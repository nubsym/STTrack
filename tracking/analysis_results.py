...
trackers = []
dataset_name = 'otb'  # lasot_extension_subset  tnl2k
"""sttrack"""
trackers.extend(trackerlist(name='sttrack', parameter_name='baseline', dataset_name=dataset_name,
                            run_ids=None, display_name='STTRACK'))
"""TransT"""
