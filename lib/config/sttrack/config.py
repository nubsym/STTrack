...
"""
Add default config for STTrack.
"""
cfg = edict()
...
# MODEL.CFA
cfg.MODEL.CFA = edict()
cfg.MODEL.CFA.NHEADS = 8
cfg.MODEL.CFA.DROPOUT = 0.1
cfg.MODEL.CFA.DIM_FEEDFORWARD = 2048
cfg.MODEL.CFA.LAYERS = 6
cfg.MODEL.CFA.DIVIDE_NORM = False
